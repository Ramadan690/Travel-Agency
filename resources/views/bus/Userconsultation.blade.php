...
<button style="font-size: 13px;" type="button" id="add_button" class="btn btn-light" onclick="$('#showBuses').DataTable().ajax.reload();"><i class="fas fa-refresh" aria-hidden="true"></i> <b>Refresh</b></button>
...
<!--------------------------------------------->
@csrf
<table id="showBuses" class="table table-sm" style="width:100%">
        <thead>
            <tr>
                <th>Reference</th>
                <th class="Title">pickup</th>
                <th class="about">destination</th>
                <th class="date">Bus_company</th>
                <th class="dur">Departure_time</th>
                <th class="dur">Arrival_time</th>
