...
<button style="font-size: 13px;" type="button" id="add_button" class="btn btn-light" onclick="$('#showCars').DataTable().ajax.reload();"><i class="fas fa-refresh" aria-hidden="true"></i> <b>Refresh</b></button>
...
<!--------------------------------------------->
@csrf
<table id="showCars" class="table table-sm" style="width:100%">
        <thead>
            <tr>
                <th>Reference</th>
                <th class="Title">CarModel</th>
                <th class="about">Fuel</th>
                <th class="date">Location</th>
                <th class="dur">price</th>
                <th class="dur">Company</th>
