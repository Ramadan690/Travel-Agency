...
<i class="fas fa-sync-alt" style="color: lightgreen"></i></a>
<input type="text" class="form-control " name="Ref" id="Ref" value="{{$users[0]->Reference}}" readonly>
</div></div>
...
<br>
  <div class="form-row">
    ...
    <div class="col-md mb-3">
      ...
      <input type="text" class="form-control " name="Title" id="Title" placeholder="" value="{{$users[0]->E_title}}" >
...
<select class="form-control" id="Categories" aria-label="Default select example"  name="Categorie">
  <option value="{{$users[0]->Categorie}}" selected>- {{$users[0]->Categorie}} -</option>
...
<select class="form-control" id="Type" aria-label="Default select example" name="types">
  <option value="{{$users[0]->Type}}" selected>- {{$users[0]->Type}} - </option>
...
<div class="col-md mb-3">
      ...
      <input type="number" class="form-control " name="Price" id="Price" placeholder="" value="{{$users[0]->price}}" >
      <div class="ErrName feed">
...
<select class="form-control" id="Bedroom" aria-label="Default select example" class="form-control" name="Bedroom">
  <option value="{{$users[0]->bedroom}}" selected>- {{$users[0]->bedroom}} -</option>
...
<select class="form-control" id="Bathroom" aria-label="Default select example" class="" name="Bathroom">
  <option value="{{$users[0]->bathroom}}" selected>- {{$users[0]->bathroom}} -</option>
  <option value="1" >1</option>
    <option value="2">2</option>
    <option value="3">3</option>
</select>
...
<select class="form-control" id="Furninshing" aria-label="Default select example" class="form-control" name="Furninshing">
  <option value="{{$users[0]->Furnishing}}" selected>- {{$users[0]->Furnishing}} -</option>
...
<div class="col-md mb-3">
      ...
      <input type="number" class="form-control " name="Sqft" id="Sqft" placeholder="" value="{{$users[0]->sqft}}" >
      <div class="ErrName feed">
...
<div class="col-md mb-3">
      ...
      <input type="number" class="form-control " name="build_year" id="build_year" placeholder="" value="{{$users[0]->build_year}}" >
      <div class="ErrName feed">
...
<select class="form-control" id="State" aria-label="Default select example" class="form-control " name="State">
  <option value="{{$users[0]->State}}" selected>- {{ $users[0]->State }} -</option>
...
<div class="col-md-3 mb-3">
      ...
      <input type="text" class="form-control " name="City" id="City" placeholder="" value="{{$users[0]->City}}" >
      <div class="ErrName feed">
...
<div class="col-md-3 mb-3">
      ...
      <input type="text" class="form-control " name="Street_Address" id="Street_Address" placeholder="" value="{{$users[0]->Street_Address}}" >
      <div class="ErrName feed">
...
<br>
  ...
  <div class="form-row">
   ...
   <div class="col-md mb-1">
      ...
      <textarea type="textarea" class="form-control " name="About" id="About" style="height: 100px">{{$users[0]->about}}</textarea>
