...
<button style="font-size: 13px;" type="button" id="add_button" class="btn btn-light" onclick="$('#showTour').DataTable().ajax.reload();"><i class="fas fa-refresh" aria-hidden="true"></i> <b>Refresh</b></button>
...
<!--------------------------------------------->
@csrf
<table id="showTour" class="table table-sm" style="width:100%">
        <thead>
            <tr>
                <th>Reference</th>
                <th class="Title">Title</th>
                <th class="about">period</th>
                <th class="date">price</th>
                <th class="dur">Start</th>
                <th class="dur">Ends</th>
