...
<form method="post"  action="{{route('AddTourUpload')}}" enctype= "multipart/form-data"  style="font-size: 15px">
  {{ csrf_field() }}
...
@enderror 
      ...
      <label for="Fuel">Package <span style="color: red">*</span></label>
...
<div class="col-md mb-3">
      ...
      <input type="Date" class="form-control " name="DateS" id="DateS" placeholder="" value="" >
      <div class="ErrName feed">
...
<div class="col-md mb-3">
      <label for="Date">Ends </label>
      <input type="Date" class="form-control " name="DateE" id="DateE" placeholder="" value="" >
      <div class="ErrName feed">
...
<div class="form-row">
        ...
        <label for="Street_Address">Includes  </label>
